...
export default class SonosDeviceBase {
   ...
   * @param {string} [uuid=randomUUID()] The UUID of the speaker like RINCON_macaddres01400, used in some commands.
   * @memberof SonosDeviceBase
   */
  constructor(host: string, port = 1400, uuid: string = randomUUID()) {
    this.host = host;
    this.port = port;
    this.uuid = uuid;
  }
